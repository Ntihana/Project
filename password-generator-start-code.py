...
#print(f"These are all Alphabets in English Language: {all_alphabets}")
all_digits = list(string.digits)
#print(f"These are all numbers in English Language: {all_digits}")
all_symbols = list(string.punctuation)
#print(f"These are all Symbols in English Language: {all_symbols}")
#########################################################################################################
...
no_of_letters = int(input("How many letters would you like in your passowrd?"))
...
print(final_password_list)
# At this time we have our password in a list lets change that to a string then print it
# accumulator for string_password

final_string_password = []
for character in final_password_list:
#      change and  append the character to the string_password
 string_password = ''.join(final_password_list)
final_string_password.append(string_password)
